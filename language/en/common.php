...
$lang = array_merge($lang, array(
	...
	'ACP_FBC_ALLOW_RESTRICT'			=> 'Allow, restrict or ignore the selected countries',
	'ACP_FBC_ALLOW_RESTRICT_EXPLAIN'	=> 'If set to allow, connections originating in the countries you select are allowed. If set to restrict, connections from all countries are allowed except those you select. If set to ignore, any countries selected are ignored and only the allow VPN services setting is used.',
	...
	'ACP_FBC_DENY_ACCESS'				=> 'Your access is denied due to the country code assigned to your Internet Protocol (IP) address. Your IP is %1$s and your country is %2$s.',
	'ACP_FBC_DENY_ACCESS_LOGIN'			=> 'Your access is denied due to the country code assigned to your Internet Protocol (IP) address. Your IP is %1$s and your country is %2$s. However, actively registered users may <a href="%3$s">login</a>.',
	'ACP_FBC_DENY_ACCESS_VPN'			=> 'Your access is denied because VPN only access is allowed. Your IP %1$s is assigned to the country %2$s.',
	'ACP_FBC_DOWNLOAD_ERROR'			=> 'Could not download: %1$s',
	'ACP_FBC_EFFECTIVELY_DISABLED'		=> 'To avoid locking down your board, all traffic is currently allowed. This can occur if no countries were selected or you chose to ignore countries AND VPN access is not allowed. Please change your settings. If you want to do this permanently, please disable this extension.',
	'ACP_FBC_FROM'						=> 'from ',
	...
	'ACP_FBC_IP_NOT_FOUND_EXPLAIN'		=> 'If a user’s IP addresses isn’t in the database, it’s assumed to be from a virtual private network (VPN) service. Enabling this option will let in these users.',
...
<option value="ZW">Zimbabwe</option>',
	...
	'ACP_FBC_REQUIREMENTS'				=> 'To install this extension, the store directory must be writable (0777 Unix file permissions). The allow_url_fopen directive must be enabled. The following PHP extensions are required: curl, dom and Phar. This extension works with phpBB 3.2 only.',
