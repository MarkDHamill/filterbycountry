...
$lang = array_merge($lang, array(
	...
	'ACP_FBC_ALLOW_RESTRICT_EXPLAIN'	=> 'If set to allow, only connections originating in the countries you select are allowed.',
	'ACP_FBC_CHANGE_REPORT_RANGE'		=> 'Change report range',
	'ACP_FBC_COUNTRIES'					=> 'Select one or more country codes',
	'ACP_FBC_COUNTRIES_EXPLAIN'			=> 'Hold the CTRL down (Command on a Mac) to select multiple country codes. You can select a range of countries by holding down the SHIFT key while selecting the first to last countries in the range. <em>To avoid accidentally locking down all access, if no countries are selected, all countries are allowed, regardless of mode. If this is what you want to do permanently, you should disable the extension.</em>',
	...
	'ACP_FBC_FROM'						=> 'from ',
	'ACP_FBC_IP_NOT_FOUND'				=> 'Action to take if the user’s IP address is not found in MaxMind database',
	'ACP_FBC_IP_NOT_FOUND_EXPLAIN'		=> 'It’s possible but unlikely that new IP addresses won’t be in MaxMind’s database. You can set a policy on how these IP addresses should be handled.',
	'ACP_FBC_KEEP_STATISTICS'			=> 'Keep statistics',
	'ACP_FBC_KEEP_STATISTICS_EXPLAIN'	=> 'If yes, statistics are kept for the number of allowed and restricted page requests by country code. <em>Warning</em>: these statistics can use a lot of database space. <em>If you set this setting to no, all statistics are erased.</em>',
	...
	'ACP_FBC_NO_STATISTICS_YET'			=> 'There are no statistics to display yet. This can happen if no country codes are selected or you just enabled statistics.',
