...
$lang = array_merge($lang, array(
	...
	'ACP_FBC_CREATE_DATABASE_ERROR'		=> 'Kan de landcode database van MaxMind niet aanmaken. Dit kan te wijten zijn aan onvoldoende rechten. De bestandsmachtigingen voor de map /store/phpbbservices van het forum moeten worden ingesteld op openbaar beschrijfbaar (777 on Unix-gebaseerde systemen).',	
	...
	'ACP_FBC_DENY_ACCESS_VPN'			=> 'Uw toegang wordt geweigerd omdat alleen VPN toegang is toegestaan. Uw IP %1$s is toegewezen aan het land %2$s.',	
	'ACP_FBC_DOWNLOAD_ERROR'			=> 'Kon niet downloaden: %1$s',
	'ACP_FBC_EFFECTIVELY_DISABLED'		=> 'Om te voorkomen dat je forum wordt vergrendeld, is al het verkeer momenteel toegestaan. Dit kan gebeuren als er geen landen zijn geselecteerd of als u ervoor hebt gekozen landen te negeren EN VPN-toegang niet is toegestaan. Wijzig uw instellingen. Schakel deze extensie uit als u dit permanent wilt doen.',	
	'ACP_FBC_FROM'						=> 'van ',
	'ACP_FBC_IGNORE'					=> 'Negeer',
	'ACP_FBC_IGNORE_BOTS'				=> 'Negeer gekende bots',
	'ACP_FBC_IGNORE_BOTS_EXPLAIN'		=> 'Zo ja, dan bevatten de statistieken niet uw bekende bots, zoals populaire zoekmachines. De bot kan de pagina mogelijk nog steeds lezen, afhankelijk van je andere instellingen. U kunt een lijst met bots zien in Groepen beheren.',	
	'ACP_FBC_IP_NOT_FOUND'				=> 'VPN services toestaan',
	'ACP_FBC_IP_NOT_FOUND_EXPLAIN'		=> 'Als de IP adressen van een gebruiker niet in de database staan, is dit waarschijnlijk van een VPN service (Virtueel Privé Netwerk). Als u deze optie inschakelt, kunnen gebruikers gebruikmaken van VPN services, maar kunnen ook spammers toegang krijgen.',
	...
	'ACP_FBC_LOG_ACCESS_ERRORS_EXPLAIN'	=> 'Zo ja, dan worden eventuele beperkte IP’s in het beheerder logboek vastgelegd. Dit kan resulteren in zeer lange logboeken.',
