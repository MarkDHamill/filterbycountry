...
$lang = array_merge($lang, array(
	...
	'ACP_FBC_ALLOW_RESTRICT_EXPLAIN'	=> 'Indien ingesteld om toe te staan, zijn alleen verbindingen van oorsprong uit de geselecteerde landen toegestaan.',
	...
	'ACP_FBC_FROM'						=> 'van ',	
	'ACP_FBC_IP_NOT_FOUND'				=> 'Te ondernemen actie als het IP-adres van de gebruiker niet wordt gevonden in de MaxMind database',
	'ACP_FBC_IP_NOT_FOUND_EXPLAIN'		=> 'Het is mogelijk maar onwaarschijnlijk dat nieuwe IP-adressen niet in de MaxMind database staan. U kunt een beleid instellen voor hoe deze IP-adressen moeten worden behandeld.',
	'ACP_FBC_KEEP_STATISTICS'			=> 'Statistieken bijhouden',
	'ACP_FBC_KEEP_STATISTICS_EXPLAIN'	=> 'Zo ja, worden statistieken bijgehouden voor het aantal toegestane en beperkte paginaverzoeken per landcode. <em>Waarschuwing</em>: deze statistieken kunnen veel databaseruimte gebruiken. <em>Als u deze instelling op Nee instelt, worden alle statistieken gewist.</em>',
...
<option value="CH">Zwitserland</option>',
	'ACP_FBC_OVERRIDE'					=> '(<em>Note</em>: Het gebruik van absolute datums overschrijft geselecteerde relatieve datums. Geef beide datums op om absolute datums te gebruiken.)',
