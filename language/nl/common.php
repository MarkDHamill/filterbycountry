...
<option value="BA">Bosnie en Herzegovina</option>
...
<option value="PF">Frans-Polynesie</option>
...
<option value="CV">Kaapverdie</option>
...
<option value="MK">Macedonie, de voormalige Joegoslavische Republiek</option>
...
<option value="FM">Micronesie, Federale Staten van</option>
<option value="MD">Moldavie, Republiek</option>
...
<option value="NC">Nieuw-Caledonie</option>
